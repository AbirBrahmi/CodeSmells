...
data <- read.csv("C:/Users/Brahm/Documents/CodeSmells/data/StudyCodeSmells/ProcessedData/RQ1/smell_counts_per_project.csv", header = TRUE)
...
p <- ggplot(data_melted, aes(x = variable, y = value)) +
  ...
  labs(title = "Distribution des code smells par projet", 
       x = "Type de smell", 
